...
namespace MalbersAnimations
{
    public class FlyBehavior : StateMachineBehaviour
    {
        ...
        override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            FallVector = animal.CurrentAnimState == AnimTag.Fall ? rb.linearVelocity : Vector3.zero;          //Just recover if your coming from the fall animations

            rb.constraints = RigidbodyConstraints.FreezeRotation;                                       //Release the Y Constraint
            rb.linearVelocity = new Vector3(rb.linearVelocity.x, 0, rb.linearVelocity.z);                                 //Clean the Y velocity
            rb.useGravity = false;
