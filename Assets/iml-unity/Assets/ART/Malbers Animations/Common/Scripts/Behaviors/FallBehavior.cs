...
namespace MalbersAnimations
{
    public class FallBehavior : StateMachineBehaviour
    {
        ...
        override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            IncomingSpeed = rb.linearVelocity;
            IncomingSpeed.y = 0;
        ...
        private void CheckforWater()
        {
            ...
            {
                rb.linearVelocity = new Vector3(rb.linearVelocity.x, 0, rb.linearVelocity.z);             //Reset the rigidbody velocity
        ...
        void AirControl()
        {
            ...
            var VerticalSpeed = rb.linearVelocity.y;
