...
namespace MalbersAnimations
{
    public class FlyDodgeBehaviour : StateMachineBehaviour
    {
        ...
        override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            momentum = InPlace ? rb.linearVelocity : animator.velocity;

        }

        override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            time = animator.updateMode == AnimatorUpdateMode.Fixed ? Time.fixedDeltaTime : Time.deltaTime;     //Get the Time Right
